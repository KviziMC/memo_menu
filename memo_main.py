...
class Question:
    def _init_(self, question, answer, wrong_answer1, wrong_answer2, wrong_answer3):
        self.question = question
        self.answer = answer
        self.wrong_answer1 = wrong_answeri
...
def menu_generation():
    if cur_q.count_ask == 0:    
        ...
        text = f'Paзів відповіли: {cur_q.count_ask}\n' \
...
def add_question():
    new_q = Question(le_question.text(), le _right_ans.text(),le_wrong_ans1.text(), le_wrong_ans2.text(),le_wrong_ans3.text())
