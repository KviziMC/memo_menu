...
lb_wrong_ans2 = QLabel('Bведіть другу хибну відповідь')
lb_wrong_ans3 = QLabel('Bведіть третю хибну відповідь')
...
vl_labels.addWidget(lb_right_ans1)
vl_labels.addWidget(lb_right_ans2)
vl_labels.addWidget(lb_right_ans3)

vl_lineEdits = QVBoxLayout()
vl_lineEdits.addwidget(le_question)
vl_lineEdits.addwidget(le_right_ans)
vl_lineEdits.addwidget(le_right_ans1)
vl_lineEdits.addwidget(le_right_ans2)
vl_lineEdits.addwidget(le_right_ans3)
